package camp.nextstep.edu.kitchenpos.menuproduct.dao;
...
@Repository
public class PersistenceMenuProductDao implements MenuProductDao {
    ...
    public PersistenceMenuProductDao(final DataSource dataSource) {
