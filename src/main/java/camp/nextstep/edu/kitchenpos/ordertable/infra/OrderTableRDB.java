package camp.nextstep.edu.kitchenpos.ordertable.infra;
...
@Repository
public class OrderTableRDB implements OrderTableRepository {
    ...
    public OrderTableRDB(final DataSource dataSource) {
