package camp.nextstep.edu.kitchenpos.tablegroup.infra;
...
@Repository
public class TableGroupRDB implements TableGroupRepository {
    ...
    public TableGroupRDB(final DataSource dataSource) {
